 ...
 */
var _hsq = _hsq || [];console.log('yesss heree')
var _paq = _paq || [];
_hsq.push(['setPortalId', 2512812]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addCookieDomain', '.hs-sites.com']);
_hsq.push(['addCookieDomain', '.symplicity.com']);
...
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/2512812.js', 'hs-script-loader']);
    ...
    hstc.tracking.Tracker.prototype.trackClick = function(t, e, i) {
        var n = this,
            r = {
                ...
                handler: function() {
                    try {
                        hstc.utils.isDefined(n.portalId) && hstc.utils.startsWith(e, "pe" + n.portalId + "_") ? n.trackCustomBehavioralEvent({
                            name: e
                        }) : n.trackEvent(e, i)
                    } catch (t) {
    ...
    ! function(t) {
        ...
        (r = nt.selectors = {
            ...
            filter: {
                ...
                CLASS: function(t) {
                    var e = w[t + " "];
                    return e || (e = new RegExp("(^|" + M + ")" + t + "(" + M + "|$)")) && w(t, function(t) {
            ...
            var i = 0,
                ...
                c = function(c, h, u, p, g) {
                    var f, d, k, m = [],
                        ...
                        w = null != g,
                        x = a,
                        _ = c || o && r.find.TAG("*", g && h.parentNode || h),
                    ...
                    if (s && v !== y) {
                        ...
                        if (c) {
                            if (y > 0)
                                for (; v--;) T[v] || m[v] || (m[v] = N.call(p));
                            m = mt(m)
                        }
                        O.apply(p, m);
                        w && !c && m.length > 0 && y + e.length > 1 && nt.uniqueSort(p)
                    }
                    if (w) {
                        C = S;
                        a = x
